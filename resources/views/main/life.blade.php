    ...
    <section class="welcome-section education">
        ...
        <div class="container">
            ...
            <div class="main">
                ...
                <form action="{{ route('user.life.update', ['username' => Auth::user()->username]) }}" method="POST" enctype="multipart/form-data" id="post-form">
                    @csrf
                    <div class="first-input">
                        @php
                            $preset = session()->pull('preset_life_event');
                        @endphp
