...
@section('content')
    <section class="join-us">
        ...
        <div class="right">
            ...
            <form method="POST" action="{{ route('register.form.second') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="input-section">
                    ...
                    <div class="next-btn-sec">
                        <button type="button" class="back-btn" onclick="window.location.href='{{ route('register') }}'">Back</button>
